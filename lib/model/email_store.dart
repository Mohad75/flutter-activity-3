...
class EmailStore with ChangeNotifier {
  ...
  static final _mainInbox = <Email>{
    const Email(
      sender: '★★★★',
      time: '24 Hours Open',
      subject: 'The Heritage Hotel',
      message: 'Address: Roxas Boulevard, corner Epifanio de los Santos Ave, Pasay, 1300 Metro Manila\n\n'
          'Located at the corner of EDSA and Roxas Boulevard, The Heritage Hotel Manila (THHM) stands proud along the Pasay City skyline. This classic 9 story , 4 star Hotel is convenient for those with an early flight as well as for those looking to explore the main historic sights, as the neighborhood is located between the Ninoy Aquino International Airport (NAIA) and Central Manila\n\n'
          'The Heritage Hotel Manila opened its doors to guests in 1994 and has 450 well appointed rooms. Outside , its architecture is modernist, but once you enter its airy lobby, it transforms into a much more classical look.Book here for our Best Price Guarantee promise. Earn and spend loyalty points on all qualifying stays. The level of points, benefits and privileges are subject to availability and may vary at certain participating hotels.',
    ...
    const Email(
      sender: '★★★★★',
      time: '12 Hours Open',
      subject: 'Kingsford Hotel Manila?',
      message:
          ' Mesmerizing and elegant hotel located in the vibrant Manila city. Book now! Great Location. City View. Spacious Suites. 24 Hour Front Desk. Amenities: Bar, Fitness Center, Indoor Pool.\n\n'
         ,
